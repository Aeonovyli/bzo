...
// unchanged.
export const SHOCK_AD_LIFE = 0.2;
...
export const BURROW_DEPTH = -1.32;
export const BURROW_SPEED_AD = 0.80;
export const BURROW_ANGULAR_AD = 0.55;
...
export const BURROW_GRAVITY_FACTOR = 4;
...
export const BURROW_RADAR_FACTOR = 0.25;
...
// as a surface.
export function canJump(abbreviation, allowJumping, airborne, flapsLeft, insideBuilding) {
...
export function getVisibleTankAlpha(abbreviation, alpha, viewerFlag, zoned = false) {
...
export function drivesThroughBuildings(abbreviation, zoned = false) {
...
export function isZoned(abbreviation, flagActive) {
...
export function togglesZoneOnTeleport(abbreviation) {
...
export function shotPassesThroughTank(shotFlag, victimZoned) {
  if (victimZoned) {
...
export function getFiredShotFlag(abbreviation, zoned) {
...
export const ZONED_TANK_ALPHA = 0.25;
...
export function getGroundLimit(abbreviation) {
...
export function getBurrowFactors(abbreviation, y) {
...
export function isCrushedByAnyone(abbreviation) {
...
export function canRunOver(rollerFlag, victimFlag, rollerY, rollerZoned = false) {

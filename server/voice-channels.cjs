...
const VOICE_CHANNEL_ALL = 'all';
const VOICE_CHANNEL_NEARBY = 'nearby';
const VOICE_CHANNEL_TEAM = 'team';

const DEFAULT_VOICE_CHANNEL = VOICE_CHANNEL_ALL;
...
function getVoiceChannel(value) {
...
function voiceChannelUsesDistance(value) {
...
function areVoicePeers(source, target, planarDistance, nearbyRadius) {
